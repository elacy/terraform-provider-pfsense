...
func (r *systemUserResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"uid":            constantComputedIntAttribute("The system UID assigned to the user."),
			...
			"expires":        optionalStringAttribute("Account expiry date (MM/DD/YYYY; empty for never).", isDate()),
